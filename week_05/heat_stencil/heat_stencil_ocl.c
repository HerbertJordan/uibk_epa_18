...
int main(int argc, char** argv) {
    ...
    size_t global_work_size[2] = { 
        extendToMultiple(size[0],workGroupSize[0]),     // must be a multiple of the work group size
    ...
    for(int t=0; t<T; t++) {
        ...
        CLU_ERRCHECK(clEnqueueNDRangeKernel(command_queue, kernel, 2, NULL, global_work_size, workGroupSize, 0, NULL, NULL), "Failed to enqueue 2D kernel");
